...
Quiz Microservice: Handles quiz creation and management.
Question Microservice: Manages the pool of questions and their details.
...
Quiz Database: Stores quiz metadata and relationships.
Question Database: Stores question details and answers.
Technologies Used
...
bash
Copy code
git clone https://github.com/<your-github-username>/quiz-application.git
